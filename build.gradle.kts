...
// Project properties
group = project.properties["modGroup"].toString()
version = project.properties["modVersion"].toString()
...
// Generates a class named rc55.mc.cauldronpp..Tags with the mod version in it, you can find it at
